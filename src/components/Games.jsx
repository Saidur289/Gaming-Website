    ...
    return (
      <div className="rounded overflow-hidden shadow-lg bg-white">
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-gray-700 text-base">{description.substring(0,70)}...</p>
        </div>
        ...
        <div className="px-6 py-4">
         <Link to = {`/review/${_id}`}> <button className="bg-purple-600 w-full text-white py-2 px-4 rounded hover:bg-purple-700 transition">
            Explore Details
          </button></Link>
        </div>
      </div>
